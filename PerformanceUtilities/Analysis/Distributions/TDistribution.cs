...
namespace PerformanceUtilities.Analysis.Distributions
{
    ...
    ///             <item>
    ///                 <description>
    ///                     <a href="http://en.wikipedia.org/wiki/Student's_t-distribution">
    ...
    /// </code>
    /// </example>
    public class TDistribution : Distribution
    {
        ...
        public TDistribution(double degreesOfFreedom)
        {
            ...
            constant = Gamma.Function((v + 1)/2.0)/(Math.Sqrt(v*Math.PI)*Gamma.Function(v/2.0));
        }
